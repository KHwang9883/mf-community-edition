...
Windows and Linux interim builds are compiled by the GitHub Actions workflow on each commit and you can download them [here][workflow-link]. These are not stable releases.
...
This project uses a [non-commercial fan-project license](LICENSE.txt). The license text and in-game disclaimer must NOT be removed.

**Allowed**, free of charge only:
- Copy and redistribute the software non-commercially
- Release modified versions
- Port the game to other platforms

**Not allowed:**
- Distribute copies commercially, modified or not (every copy must be free of charge)
- Remove this license or the disclaimer
- Claim this software as your own work without the express written consent of Meteo Dream
...
[workflow-link]: https://nx.wtf/s/2GqcQ
