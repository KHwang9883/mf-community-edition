...
const DEATH_SOUNDS = [
	...
	preload("res://objects/chorniy_mario/death_sounds/spongebob-fail.mp3"), "res://objects/chorniy_mario/death_sounds/ktkm9.mod", # Yes, this is not a preload. This is not a bug!
	...
	preload("res://objects/chorniy_mario/death_sounds/yippee-tbh.mp3"),preload("res://objects/chorniy_mario/death_sounds/thirdstar/aah.ogg"), preload("res://objects/chorniy_mario/death_sounds/thirdstar/died.wav.ogg"), preload("res://objects/chorniy_mario/death_sounds/thirdstar/dshoof.wav.ogg"), preload("res://objects/chorniy_mario/death_sounds/thirdstar/lburn1.wav.ogg"), preload("res://objects/chorniy_mario/death_sounds/thirdstar/longboing.wav.ogg"), preload("res://objects/chorniy_mario/death_sounds/thirdstar/weoow.wav.ogg"), 
	...
	preload("res://objects/chorniy_mario/death_sounds/thirdstar/arabic_tune.ogg"),preload("res://objects/chorniy_mario/death_sounds/new/media.av.extract.audio (1).mp3"),
	preload("res://objects/chorniy_mario/death_sounds/very_new/weregonnacheat.ogg"), "res://objects/chorniy_mario/death_sounds/new/mariochi.mod", # Yes, this is not a preload. This is not a bug!
]
