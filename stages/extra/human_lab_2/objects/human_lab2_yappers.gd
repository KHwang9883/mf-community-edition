...
@onready var yapper_1_lines = [
	preload("res://sfx/house_of_clones/AAA_gadacz2-1.wav"), preload("res://sfx/house_of_clones/AAA_gadacz2-2.wav"), preload("res://sfx/house_of_clones/AAA_gadacz2-3.wav"),
]
@onready var yapper_2_lines = [
	preload("res://sfx/house_of_clones/AAA_gadacz2-1b.wav"), preload("res://sfx/house_of_clones/AAA_gadacz2-2b.wav"), preload("res://sfx/house_of_clones/AAA_gadacz2-3b.wav"),
]
