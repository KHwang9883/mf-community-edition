...
@export var platform = preload("res://stages/extra/climbing_minigame/objects/platform_custom/platform_path_custom.tscn")
@export var skulltroopa = preload("res://stages/extra/climbing_minigame/objects/paratroopa_skull/paratroopa_green_skully.tscn")
@export var coins = preload("res://stages/extra/climbing_minigame/objects/coins/coins.tscn")
@export var flower = preload("res://stages/extra/climbing_minigame/objects/fire_flower/fire_flower_lava_run.tscn")
@export var podoboo = preload("res://engine/objects/enemies/podoboo/podoboo.tscn")
@export var STIHL = preload("res://stages/extra/climbing_minigame/objects/stihl/stihl.tscn")
...
@export var  BIG_FISH_BONES = preload("res://stages/extra/climbing_minigame/objects/big_fish_bones/big_fish_bones.tscn")
@export var  MARIO = preload("res://stages/extra/climbing_minigame/objects/mario.tscn")
@export var  PLATFORM_PATH_CLOUD = preload("res://engine/objects/platform/platform_path_cloud.tscn")
#const PLATFORM_PATH_CLOUD = preload("res://engine/objects/platform/castle_platforms/long_platform.tscn")
@export var  BULLET_LAUNCHER_STRUCTURE = preload("res://stages/extra/climbing_minigame/objects/bullet_launcher_structure/bullet_launcher_structure.tscn")
@export var  BULLET_FIRE_LAUNCHER_STRUCTURE = preload("res://stages/extra/climbing_minigame/objects/bullet_launcher_structure/bullet_fire_launcher_structure.tscn")
@export var  SND_BOWSER_LAUGH = preload("res://music/climbing_minigame/snd_bowser_laugh.ogg")
@export var  LAKITU = preload("res://engine/objects/enemies/lakitus/lakitu.tscn")
@export var  GOOMBA = preload("res://engine/objects/enemies/goombas/goomba.tscn")
@export var  EXPERT_BULLET_LAUNCHER_STRUCTURE = preload("res://stages/extra/climbing_minigame/objects/bullet_launcher_structure/expert_bullet_launcher_structure.tscn")
