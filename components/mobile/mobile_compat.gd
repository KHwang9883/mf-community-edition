...
func _show_mobile_header(page: Node) -> void:
	var header := page.get_node_or_null(NodePath("MobileHeader"))
	if header:
		header.visible = true
	var header2 := page.get_node_or_null(NodePath("MobileHeader2"))
	if header2:
